...
1. Fine-tuning fastText models for each video metadata type in case of the binary/ternary variant of the original model. Alternatively, BERT embeddings of the video metadata types are computed (using [`bert_embeddings.ipynb`](bert_embeddings.ipynb)) in case of the BERT version of the model.
