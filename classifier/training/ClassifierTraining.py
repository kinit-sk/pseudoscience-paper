...
from classifier.featureengineering.BertDataPreparation import BertDataPreparation
...
class ClassifierTraining(object):
    ...
    def __init__(self, dataset_object=None, gpu_training=False):
        ...
        self.DATA_PREPARATION = BertDataPreparation(dataset_object=self.DATASET)

        # Set Base Directories
        self.TRAINING_MODELS_BASE_DIR = 'classifier/training/bert_temp'
        self.BEST_MODEL_BASE_DIR = 'pseudoscientificvideosdetection/models/bert'

        # Create a Pseudoscience Model Object
        self.DEEP_LEARNING_MODEL_OBJ = PseudoscienceDeepLearningModel()
        self.DEEP_LEARNING_MODEL_OBJ.summarize_model()
    ...
    def train_model(self):
        ...
        for train_val_set_indices, test_set_indices in stratified_kfold.split(X=self.dataset_videos, y=self.dataset_labels_categorical):
            ...
            model = PseudoscienceDeepLearningModel().get_model()
